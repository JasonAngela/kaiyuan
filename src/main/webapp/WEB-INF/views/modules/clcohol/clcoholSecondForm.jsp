...
<body>
	<ul class="nav nav-tabs">
		<li class="active">酒精第二鉴定人</li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="clcoholSecond" action="${ctx}/clcohol/clcoholSecond/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
<h4 class="h-height">二:基本案情</h4>
	 ...
	 <div class="control-group">
		...
		<%-- <div class="control-group">
			<label class="control-label">（一）检材的一般检验及描述</label>
				<div class="controls">
...
<h4 class="h-height">五、检测结果</h4>
		...
		<div class="form-actions" style="padding:0;text-align: center;">
			<shiro:hasPermission name="clcohol:clcoholSecond:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
