...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/clcohol/clcoholPapers/">酒精底稿列表</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="clcoholPapers" action="${ctx}/clcohol/clcoholPapers/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
<<h4 class="h-height">二:检案摘要</h4>
	 ...
	 <div class="control-group">
		 ...
		 <h4 class="h-height">四:检验结果</h4>	
		<div class="control-group">
			<div class="controls content1">
			${clcoholPapers.workinstruction}
			</div>
			<div class="list1"></div>
		</div>
