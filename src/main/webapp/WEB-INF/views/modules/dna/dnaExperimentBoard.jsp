...
<body>
	...
	<form:form id="inputForm" modelAttribute="dnaExperiment" action="${ctx}/dna/dnaExperiment/board/save" method="post" class="breadcrumb form-search">
		...
		<table id="contentTable" class="table table-striped table-bordered table-condensed">
			...
			<c:forEach items="#{dnaExperiment.board.dnaBoardJggList}" var="row" varStatus="kl">	
					...
					<td>
						...
						readonly="readonly" onclick="selectedPosition(${row.hang},${row.lie })"
		...
		<tr>
			<th>甲酰胺批号</th>
			<td><input name="formamideBatchNumber" htmlEscape="false" maxlength="255" class="input-xlarge "/></td>
			<th>是否已验证有效</th>
			<td>
		...
		<tr>
			<th>内标</th>
			<td><input type="text"name="internalStandard" htmlEscape="false" maxlength="255" class="input-xlarge "/></td>
			<th>是否已验证有效</th>
			<td>
		...
		<tr>
			<th>实验室温度</th>
			<td><input type="text" name="temperature" htmlEscape="false" maxlength="255" class="input-xlarge "/></td>
			<th>冰箱温度</th>
			<td><input type="text" name="refrigeratorTemperature" htmlEscape="false" maxlength="255" class="input-xlarge "/></td>			
		</tr>
		<tr>
			<th>产物取量和处理</th>
			<td><input type="text" name="product" htmlEscape="false" maxlength="255" class="input-xlarge "/></td>	
			<th>相对湿度</th>
			<td colspan="3"><input type="text" name="humidity" htmlEscape="false" maxlength="255" class="input-xlarge "/></td>		
		</tr>
	
		<tr>
			<th>阳性对照</th>
			<td ><input type="text" name="positiveControl" htmlEscape="false" maxlength="255" class="input-xlarge "/></td>
			<th>阴性对照</th>
			<td ><input type="text" name="negativeControl" htmlEscape="false" maxlength="255" class="input-xlarge "/></td>
		</tr>
