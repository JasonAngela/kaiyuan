...
<body>
		...
		<form:form id="inputForm" modelAttribute="dnaExperiment" action="${ctx}/dna/dnaExperiment/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
<%-- 		<sys:message content="${message}"/>		
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="boardId">
					<form:options items="${boardList}" itemLabel="code" itemValue="id"/>
				</form:select>
				&nbsp;
	...
	<%-- 	<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="control-group">
				<label class="control-label">实验样品：</label>
				<div class="controls">
					<table id="contentTable" class="table table-striped table-bordered table-condensed" style="width: 180px;">
						...
						<%--<shiro:hasPermission name="dna:dnaExperiment:edit">
							<tfoot>
							<tr>
								<td colspan="8">
									<a href="javascript:" onclick="addRow('#dnaExperimentSpecimenList', dnaExperimentSpecimenRowIdx, dnaExperimentSpecimenTpl);dnaExperimentSpecimenRowIdx = dnaExperimentSpecimenRowIdx + 1;" class="btn">新增</a>
								</td>
							</tr>
						</tfoot>
						</shiro:hasPermission>--%>
					...
					<script type="text/template" id="dnaExperimentSpecimenTpl">//<!--
						<tr id="dnaExperimentSpecimenList{{idx}}">
							...
							<td>
								<input type="text" id="dnaExperimentSpecimenList{{idx}}_specimenCode" name="dnaExperimentSpecimenList[{{idx}}].specimenCode" value="{{row.specimenCode}}" style= "background-color:#CDCDC1"  class="input-medium" />
							</td>
