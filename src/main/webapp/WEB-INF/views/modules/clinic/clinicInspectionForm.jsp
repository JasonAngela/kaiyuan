...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/clinic/clinicInspection/form?id=${clinicInspection.id}">法医第二鉴定人复检<shiro:hasPermission name="clinic:clinicInspection:edit">${not empty clinicInspection.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="clinic:clinicInspection:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="clinicInspection" action="${ctx}/clinic/clinicInspection/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
<div id="light" class="white_content" > 
 ...
 <h1 align="center">上海开元司法鉴定中心<br/>
		...
		<div class="control-group">
			...
			${clinicFirstdraft.clinicAttorney}
			</div>
			<div class="list"></div>
			<form:hidden path="clinicAttorney" id="content_value"/>
		</div>
		...
		<div class="control-group">
			<div id="icon1" style="display: none; position: absolute;" title="添加批注">
				...
				${clinicFirstdraft.clinicThisPaper}
				</div>
				<div class="list1"></div>
		...
		<div class="control-group">
			...
			<div id="icon2" style="display: none; position: absolute;" title="添加批注">
				...
				${clinicFirstdraft.inspectionMethods}
				</div>
				<div class="list2"></div>
		  ...
		  <div class="control-group">
			...
			${clinicFirstdraft.appraisalStandard}
			</div>
			<div class="list3"></div>
	...
	<h3>分析说明</h3>	
		<div class="control-group">
			...
			${clinicFirstdraft.analysisShows}
			</div>
			<div class="list7"></div>
		...
		<div class="control-group">
			...
			${clinicFirstdraft.expertOpinion}
			</div>
			<div class="list8"></div>
		...
		<div class="control-group">
			...
			${clinicFirstdraft.remarks}
			</div>
			<div class="list9"></div>
			<form:hidden path="remarks" id="content_value9"/>
		</div>
		<div class="control-group">
			<label class="control-label">第二鉴定人：</label>
			<div class="controls">
				<input name="secondSurveyor" value="${user}" readonly="readonly"> 
			</div>
		</div>
		</div> 
		<div class="form-actions">
			<shiro:hasPermission name="clinic:clinicInspection:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
