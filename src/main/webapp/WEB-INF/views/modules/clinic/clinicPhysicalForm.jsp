...
<body>
	<ul class="nav nav-tabs" id="lover1">
		<li class="active"><a href="${ctx}/clinic/clinicPhysical/form?id=${clinicPhysical.id}">材料登记<shiro:hasPermission name="clinic:clinicPhysical:edit">${not empty clinicPhysical.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="clinic:clinicPhysical:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
...
<input type="hidden" name="register.id" value="${registerId}" >
	<div id="a" class="o" >
		<h3 align="center">上海开元司法鉴定中心<br/>
		    临床取（采）样 表</h3>
		<h5 style="margin-left:494px;" id="lover1" >检案编号：开元[${simple}]伤鉴字第${casecode}号</h5>
	</div>
		...
		<div class="form-actions" id="lover" >
			<shiro:hasPermission name="clinic:clinicPhysical:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
