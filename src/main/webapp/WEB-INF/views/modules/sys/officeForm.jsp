...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/office/list?id=${office.parent.id}&parentIds=${office.parentIds}">机构列表23</a></li>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">鉴定人证:</label>
			<div class="controls">
				<form:hidden id="address" path="address" htmlEscape="false" maxlength="255" class="input-xlarge"/>
				<sys:ckfinder input="address" type="images" uploadPath="/address" selectMultiple="false" maxWidth="100" maxHeight="100"/>
			</div>
		</div>
