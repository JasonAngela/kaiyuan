	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li>
							<img alt="头像" src="/photo/user/${fns:getUser().loginName}/${fns:getUser().loginName}.jpg"  style="width:49px; height:47px; border-radius:50%; overflow:hidden;"/> 
					</li>	
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            ${fns:getConfig('productName')} - Powered By <a href="http://jeesite.com" target="_blank">JeeSite</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
