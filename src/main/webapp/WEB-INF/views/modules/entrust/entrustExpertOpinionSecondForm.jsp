...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/entrust/entrustExpertOpinion/form?id=${entrustExpertOpinion.id}">DNA第二鉴定人意见 <shiro:lacksPermission name="entrust:entrustExpertOpinion:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
...
border-bottom-color: #000;">基因座名称</th>
	...
	<form:form id="inputForm" modelAttribute="entrustExpertOpinion" action="${ctx}/entrust/entrustExpertOpinion/save" method="post" class="form-horizontal">
		...
		<input type="hidden" value="${user}" id="userId"> 
			<input type="hidden" value="第二鉴定人" name="userBy"> 
