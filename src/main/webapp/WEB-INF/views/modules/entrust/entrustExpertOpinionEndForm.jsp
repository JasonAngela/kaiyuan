...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/entrust/entrustExpertOpinion/form?id=${entrustExpertOpinion.id}">DNA成文修改<shiro:lacksPermission name="entrust:entrustExpertOpinion:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="entrustExpertOpinion" action="${ctx}/entrust/entrustExpertOpinion/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">分析说明(终版)：</label>
			<div class="controls">
				<form:textarea path="finalVersion" htmlEscape="true" rows="4" maxlength="1000" class="input-xxlarge" id="explain"/>
			 	<sys:ckeditor replace="finalVersion" uploadPath="/dna/experiment" height="150"/>
			</div>
