...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/entrust/entrustExpertOpinion/form?id=${entrustExpertOpinion.id}">DNA授权签字人意见 <shiro:lacksPermission name="entrust:entrustExpertOpinion:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
...
border-bottom-color: #000;">基因座名称</th>
	...
	<form:form id="inputForm" modelAttribute="entrustExpertOpinion" action="${ctx}/entrust/entrustExpertOpinion/save" method="post" class="form-horizontal">
		...
		<input type="hidden" value="${user}" id="userId"> 
			<input type="hidden" value="授权签字人" name="userBy"> 
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="directorRemark" htmlEscape="true" rows="4" maxlength="255" class="input-xxlarge"/>
			</div>
		</div>
		<div class="control-group">
