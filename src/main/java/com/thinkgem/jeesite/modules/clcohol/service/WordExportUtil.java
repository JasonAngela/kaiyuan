...
public class WordExportUtil {
     ...
     */
    public static void writeResponse( String version,  String docFileName, String templateDir, String templateFile, Map<String, Object> beanParams,ClcoholRegister clcoholRegister) {
        ...
        try {
            ...
            // 换成D盘
            String docName = "D:"+File.separator+"information"+File.separator+"毒物"+File.separator+clcoholRegister.getCode()+File.separator+docFileName;
