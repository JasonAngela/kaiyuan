...
public class WordExportUtil {
     ...
     */
    public static void writeResponse( String version,  String docFileName, String templateDir, String templateFile, Map<String, Object> beanParams,ClinicRegister clinicRegister) {
        ...
        try {
            ...
            // 换成D盘
            String docName = "D:"+File.separator+"information"+File.separator+"法医临床病理"+File.separator+clinicRegister.getCode()+File.separator+docFileName;
