...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_APPRAISAL = new String[]{"appraisal", "entrust_register"};
	public static final String[] PD_DNA_APPRAISAL = new String[]{"dna_appraisal", "dna_experiment"};
	public static final String[] PD_CLINIC = new String[]{"clinic", "clinic_register"};
	public static final String[] PD_ALCOHOL  = new String[]{"clcohol","clcohol_register"};
